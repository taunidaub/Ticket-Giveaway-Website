...
var autoSuggest = new Class({
	...
	options: {
			...
			minLength: 2,	// the minimum length (character count) before requests are sent
			...
			queryTerm: 'input', // the queryString name to be sent to the remote suggestion server (.../?query=searchForMe)
